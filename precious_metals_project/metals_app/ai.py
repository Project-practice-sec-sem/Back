...
class AI_V1:
    ...
    def analyze_metals(self, price_dict):
        system_message = "Ты специалист по драгоценным металлам. Давай краткие советы без лишних слов. Формат вывода: Золото (XAU) Тренд: Причина: Совет: и так для всех металлов"
